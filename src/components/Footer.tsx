...
const Footer = () => {
	...
	const socialLinks = [
		{ name: 'GitHub', href: 'https://github.com/Rajbhar0710', icon: Github },
		{ name: 'LinkedIn', href: 'https://www.linkedin.com/in/rajrajbhar/', icon: Linkedin },
		{ name: 'Email', href: 'mailto:rajrajbahr.321@gmail.com', icon: Mail }
	];
					...
					<div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
						...
						<div className="space-y-6">
							...
							<div className="space-y-4">
								<a 
									href="mailto:rajrajbahr.321@gmail.com" 
									className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors group"
								>
									<div className="p-2 bg-white/10 rounded-lg group-hover:bg-white/20 transition-colors">
										<Mail className="w-4 h-4 text-white" />
									</div>
									<span className="text-sm">rajrajbahr321@gmail.com</span>
								</a>
								
								<a 
									href="tel:+91 8319641185"
									className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors group"
								>
									<div className="p-2 bg-white/10 rounded-lg group-hover:bg-white/20 transition-colors">
										<Phone className="w-4 h-4 text-white" />
									</div>
									<span className="text-sm">+91 8319641185</span>
								</a>
							</div>

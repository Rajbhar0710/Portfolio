	...
	const socialLinks = [
		{
			...
			label: 'GitHub',
			link: 'https://github.com/Rajbhar0710',
			color: 'hover:bg-gray-800'
		},
		{
			icon: <Linkedin className="w-6 h-6" />,
			label: 'LinkedIn',
			link: 'https://www.linkedin.com/in/rajrajbhar/',
			color: 'hover:bg-blue-600'
		},
		{
			icon: <MessageCircle className="w-6 h-6" />,
			label: 'WhatsApp',
			link: 'https://wa.me/+918319641185',
						...
						{modalType === 'email' && (
							<div className="text-center space-y-6">
								...
								<div>
									...
									<p className="text-xl font-bold text-gray-300">rajrajbahr.321@gmail.com</p>
								</div>
								<a
